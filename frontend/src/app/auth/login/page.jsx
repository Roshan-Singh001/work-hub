            ...
            <div className="">
                ...
                <Card className="overflow-hidden shadow-xl p-0">
                    <CardContent className="grid p-0 md:grid-cols-2">
                        ...
                        <div className="flex flex-col h-[90vh] border rounded-r-xl border-slate-200/80 p-4">
                            <div className="flex flex-col items-center gap-2 text-center">
                                <h1 className="text-2xl font-bold">Welcome back</h1>
                                <p className="text-balance text-muted-foreground">
                                    Login to your Work Hub account
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col flex-1 justify-between items-center">
                                ...
                                <p className="text-xs text-center text-muted-foreground pt-1 mt-auto">
