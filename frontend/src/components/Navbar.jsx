                            ...
                            <NavigationMenuList>
                                ...
                                <NavigationMenuItem>
                                    <NavigationMenuLink asChild>
                                        <Link href="/" className="inline-flex h-9 items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:outline-none cursor-pointer" passHref>
                                            Home
                                        </Link>
                                    </NavigationMenuLink>
                                </NavigationMenuItem>
                                        ...
                                        <div className="w-[320px] p-3">
                                            ...
                                            <ul className="space-y-1">
                                                {hireTalentLinks.map(({ href, icon: Icon, label, description, badge }) => (
                                                    <li key={href}>
                                                        <NavigationMenuLink asChild>
                                                            <Link href={href} className="group flex items-start gap-3 rounded-md p-3 hover:bg-accent transition-colors cursor-pointer" passHref>
                                    ...
                                    <nav className="flex-1 overflow-y-auto px-3 py-3 space-y-1">
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <ChevronRight
                                                    className={`w-4 h-4 text-muted-foreground transition-transform duration-200 ${mobileHireOpen ? "rotate-90" : ""
                                                        }`}
                                                />
                                            </button>
